...
public class OkTabIndicator extends HorizontalScrollView {
    ...
    // ################### TAB 通用的属性 ################################
    private float   mTabPaddingLeft   = 16;
    private float   mTabPaddingRight  = 16;
    ...
    private float   mTabTextSize      = 20;
    private boolean mTabTextBlod      = false;
    private float   mUnderLineHeight  = 10;
    ...
    private float mPagerOffset     = 0f; //pager偏移
    private int   mCurrentPosition = 0;  //当前位置

    /**
     * 观察者集合
     */
    private List<ViewPager.OnPageChangeListener> mListeners = new LinkedList<ViewPager
    ...
    public OkTabIndicator(Context context) {
        this(context, null);
    }

    public OkTabIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void notifyOnPageScrolled(int position, float positionOffset, int
    ...
    /**
     * @return line style
     * @see {@link OkTabIndicator#LINE_STYLE_MATCH}
     * @see {@link OkTabIndicator#LINE_STYLE_WRAP}
     */
    ...
    /**
     * @return
     * @see {@link OkTabIndicator#TRIANGLE_STYLE_FILL}
     * @see {@link OkTabIndicator#TRIANGLE_STYLE_STROKE}
     */
